...
RCT_EXPORT_VIEW_PROPERTY(setCache, BOOL)
...
RCT_EXPORT_METHOD(playLocalPath:(nonnull NSNumber *) reactTag path:(nonnull NSString *)path){
    [self.bridge.uiManager addUIBlock:^(RCTUIManager *uiManager, NSDictionary<NSNumber *,UIView *> *viewRegistry) {
         AliyunPlayer * aliPlayer  = (AliyunPlayer *) viewRegistry[reactTag];
         [aliPlayer playLocalPath:path];
     }];
}
RCT_EXPORT_METHOD(playVidSts:(nonnull NSNumber *)reactTag
